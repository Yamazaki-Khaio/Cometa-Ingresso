...
import ComboBoxFiltroEventos from "@/components/ClienteLogado/ComboBoxFiltroEventos"
...
export default function ListaEventosCliente(props: any){
    return(
        /*ajeitar o componente do combo box
        <div>
            <ComboBoxFiltroEventos/>
        </div>*/
        <div className="flex flex-wrap gap-5 justify-start items-start p-10">
