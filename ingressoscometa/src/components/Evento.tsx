export default function Evento(props:any) {
    ...
    return (
        ...
        <div className="absolute inset-0 mx-auto rounded-2xl overflow-hidden">
            <img src={props.Image} alt={props.Nome} className="w-full border h-48 rounded-3xl scale-105 transition-transform duration-300 ease-in-out transform hover:scale-110" />
            </div>
